        ...
        <div class="col-12">
            <div class="card card-border-color card-border-color-primary shadow">
                ...
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('usuarios.create') }}" class="btn btn-warning align-self-center">Añadir
                        Usuario</a>
                </div>
                        ...
                        <table id="mytable" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle d-none d-xl-table-cell">{{ $usuario->email }}</td>
                                    <td class="align-middle d-none d-md-table-cell">{{ $usuario->usuario }}</td>
                                    {{-- <td class="align-middle"><span class="btn btn-outline-secondary btn-sm text-capitalize">{{ $usuario->perfil->profile_type }}</span>
                                    </td> --}}
                                    <td class="align-middle">
                                        {{-- <span class="btn btn-outline-secondary btn-sm text-capitalize">{{ $usuario->perfil->profile_type }}</span>
                                        --}}
                                        @switch($usuario->perfil->profile_type)
                                            @case('superadmin')
                                                <button type="button" class="btn btn-success btn-sm btn-block">
                                                    <i class="fas fa-crown d-lg-none"></i>
                                                    <span class="text-capitalize d-none d-lg-block">{{ $usuario->perfil->profile_type }}</span>
                                                </button>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <a class="btn btn-warning btn-sm"
                                                href="{{ route('usuarios.show', $usuario->id) }}"><i
                                                    class="fas fa-eye d-lg-none"></i><span
                                                    class="d-none d-lg-block">Detalle</span></a>


                                            <a class="btn btn-outline-warning btn-sm mr-1 ml-1"
                                                href="{{ route('usuarios.edit', $usuario->id) }}"><i
                                                    class="fas fa-edit d-lg-none"></i><span
                                                    class="d-none d-lg-block">Editar</span></a>
                                            ...
                                            <form class="d-inline"
                                                ...
                                                <button class="btn btn-dark btn-sm" type="submit"><i
                                                        class="fas fa-trash-alt d-lg-none"></i><span
                                                        class="d-none d-lg-block">Eliminar</span></button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
